...
> **Примечание**: Параметр `-WindowStyle Hidden` скрывает окно PowerShell при запуске, обеспечивая скрытую работу скрипта.
...
```powershell
.\DiscordBypass.ps1 -DiscordPath "C:\Program Files\Discord\Discord.exe"
```
